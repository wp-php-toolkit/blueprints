...
export type Blueprint = {
	 ...
	 * These semantics will, instead, be expressed as follows:
	 *
	 * ```json
	 * {
	 *     "plugins": [
	 ...
	 * intentionally restricted to a subset of those: JSON-serializable values. This is
	 * to prevent passing JavaScript Date objects.
	 *
